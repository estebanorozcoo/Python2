...
async function navigate(path) {
    ...
    <nav>
        ...
        <button id="logout-btn" type="button">Logout <img src="./resources/logout.png" alt="logout" class="logout"></button>
    </nav>
    `;
    ...
    if (isLoggedIn) {
        mainGrid.style.gridTemplateColumns = "18% 1fr";
...
function setupEnrollment() {
    const display = document.getElementById("enrollment-list");
    const currentUserID = localStorage.getItem("userID");
    display.innerHTML = `
    <tr>
        <th></th>
